...
namespace IbrahimDVLDDataAccessLayer
{
    public class clsPeopleDataAccess
    {
        ...
        public static bool GetPersonInfoByPersonID(int ID, ref string FirstName, ref string SecondName, ref string ThirdName,
                                         ref string LastName, ref string NationalNUmber, ref DateTime DateOfBirth,
                                         ref byte Gendor, ref string Phone, ref string Email, ref int CountryID,
